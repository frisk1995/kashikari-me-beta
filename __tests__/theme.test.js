...
const THEME_IDS = ['green', 'blue', 'dark', 'coral'];

// 1. 4テーマすべてが存在する
assert(THEME_IDS.every((id) => themes[id]), '4テーマ（green/blue/dark/coral）が定義されている');
...
assert(themes.dark.bg === '#121212', 'dark.bg = #121212');
